...
router.post('/upload',LoginRequired, function(req, res){
	...
	try {
		//var form = new formidable.IncomingForm();  
                //var form = new formidable.IncomingForm({multiples:true,maxFieldsSize:2042220174,maxFileSize:2042220174,uploadDir: DownloadFolder});
		// specify that we want to allow the user to upload multiple files in a single request
		//form.multiples = true;
//var form = new formidable.IncomingForm({multiples:true,maxFieldsSize:20 * 1024 * 1024 ,maxFileSize: 20 * 1024 * 1024,uploadDir: DownloadFolder});  
//var form = new formidable.IncomingForm({multiples:true,maxFieldsSize:20 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 ,maxFileSize: 20 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024,uploadDir: DownloadFolder});  
//var form = new formidable.IncomingForm({multiples:true,maxFieldsSize:20 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024* 1024 * 1024 * 1024 * 1024 * 1024 * 1024 ,maxFileSize: 20 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024* 1024 * 1024 * 1024 * 1024 * 1024 * 1024,uploadDir: DownloadFolder});  
var form = new formidable.IncomingForm({multiples:true,maxFieldsSize:20 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024* 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024* 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024* 1024 * 1024 * 1024 * 1024 * 1024 * 1024 ,maxFileSize: 20 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024* 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024* 1024 * 1024 * 1024 * 1024 * 1024 * 1024 ,uploadDir: DownloadFolder});  
